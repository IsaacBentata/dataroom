    ...
    <Section>
      ...
      <div className="relative">
        ...
        <div className="relative pl-14 md:pl-18 pb-12">
          ...
          <div className="bg-surface rounded-2xl border border-accent-green/30 p-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
              <div className="text-center">
                ...
                <div className="text-xs text-foreground-secondary">MAUs</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-bold text-accent-blue">80K+</div>
                <div className="text-xs text-foreground-secondary">DAUs</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-bold text-accent-purple">34%</div>
                <div className="text-xs text-foreground-secondary">D7 Retention</div>
              </div>
              <div className="text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
              <div className="text-center">
                ...
                <div className="text-xs text-foreground-secondary">D30 Retention</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-foreground-secondary">Team Size</div>
              </div>
            </div>
          ...
          <div className="bg-surface rounded-2xl border border-accent-blue/30 p-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-6">
              <div className="text-center bg-surface-elevated rounded-xl p-3">
                ...
                <div className="text-xs text-foreground-secondary">Target MAUs</div>
              </div>
              <div className="text-center bg-surface-elevated rounded-xl p-3">
              ...
              <div className="text-center bg-surface-elevated rounded-xl p-3">
                ...
                <div className="text-xs text-foreground-secondary">Time Spent/Day</div>
              </div>
            </div>

            {/* How We Get There */}
            <h4 className="text-sm font-medium mb-3">How we get there</h4>
            <div className="space-y-3 text-foreground-secondary text-sm leading-relaxed mb-6">
              <p>
            ...
            {/* Why achievable */}
            <div className="bg-surface-elevated rounded-xl p-4 mt-5">
        ...
        <div className="relative pl-14 md:pl-18 pb-12">
          ...
          <div className="bg-surface rounded-2xl border border-accent-purple/30 p-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-6">
              ...
              <div className="text-center bg-surface-elevated rounded-xl p-3">
                ...
                <div className="text-xs text-foreground-secondary">Organic Acquisition</div>
              </div>
            </div>
        ...
        <div className="relative pl-14 md:pl-18 pb-12">
          ...
          <div className="bg-surface rounded-2xl border border-accent-orange/30 p-5">
