...
export const teamMembers = [
  {
    ...
    bio: [
      ...
      "At Equals: co-leads product development, runs marketing through a fully agentic acquisition workforce, and drives product analytics and A/B testing.",
      "Built the entire AI stack in-house. Cut per-user inference costs from $0.27 to $0.01, powering recommendations, safety, and personalization at scale.",
      "Core contributor to the engineering team. Architect of the platform's recommendation system.",
    ],
  ...
  },
  {
    ...
    bio: [
      ...
      "Co-founded Fair.xyz, which grew into Europe's largest NFT minting platform, processing $45M in NFT sales volume.",
      "At Equals: leads licensing negotiations with major labels and publishers (including the UMG worldwide deal).",
  ...
  },
  {
    ...
    bio: [
      "Product designer and 0-to-1 builder. Worked across London, Portland, Hong Kong, and Shanghai.",
      "Shipped products for Apple, Nike, AKQA, Wieden+Kennedy, and Net-a-Porter.",
      "At Nike, built key parts of the company's early app ecosystem.",
      "As a founder, built and launched his own product from the ground up with end-to-end ownership.",
    ],
  ...
  },
  {
    ...
    bio: [
      ...
      "At Muni Tienda, built the entire technical ecosystem from zero: architecture, infrastructure, coding standards, tooling, and CI/CD.",
      "Scaled into Head of Engineering, hiring and structuring Domain-Driven teams and defining career paths.",
      "At Equals: owns the full mobile development lifecycle, ecosystem design, and integration with global music content providers.",
    ],
  ...
  },
  {
    ...
    bio: [
      "12+ years of engineering experience, primarily in the React Native ecosystem.",
      ...
      "Ex-Callstacker (the most prominent React Native-focused company). Organised React Conf and React Native Universe conferences.",
      "Built core components of Amazon's Kepler (Vega) OS, which shipped React Native baked in.",
      "Built his own streaming application. First-hand knowledge of the platform and business side of running a consumer app.",
    ],
    linkedin: "",
  ...
  },
  {
    ...
    detail: "Leads AI orchestration at Equals.",
    bio: [
      "10+ years of full-stack engineering across fintech, music-tech, and Web3.",
      "Leads AI orchestration at Equals.",
      "Previously Lead Developer at Encore Musicians (UK's largest musician bookings platform) for nearly four years.",
      "React Native, Next.js, Node.js, and modern infrastructure.",
  ...
  },
  {
    ...
    bio: [
      "At Equals: improved Android crash-free users from 85% to 98%+ and crash-free sessions from 95% to 99%.",
      ...
      "Built Community Channels from zero to one: full create/join/manage feature including conditions, artist profile integration, and share flows.",
      ...
      "Previously co-built the first Bitcoin hardware wallet (Ledger) integration for a crypto browser extension. No prior implementation existed.",
  ...
  },
  {
    ...
    bio: [
      "Internationally recognised DJ. Brings an artist's instinct and insider network to product building.",
      "Connected to musicians, producers, DJs, and label executives across multiple scenes and continents.",
      "Designed and launched Equals' ambassador programme from scratch. In eight months, took the platform past one billion views on TikTok.",
      "Scaled the programme to an 11-strong ambassador network she runs today.",
      "Previously led artist liaison and supported A&R.",
      "Now leads quality assurance across iOS and Android: structured manual testing, regression, and release validation.",
