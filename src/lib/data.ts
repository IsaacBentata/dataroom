...
export function parseMAUData() {
  ...
  const mau = [4304, 3747, 4331, 11973, 25639, 41347, 59331, 97413, 145088, 235226, 283728, 350741];
  const installs = [3382, 2726, 3147, 10397, 21978, 34266, 50026, 83766, 119958, 196350, 215970, 243427];
...
export function parseWeeklyRetention() {
  ...
  const w1 = [0.2997, 0.2803, 0.2917, 0.3539, 0.3206, 0.4324, 0.452, 0.5027, 0.5172];
  const w2 = [0.1987, 0.1865, 0.1977, 0.2297, 0.2032, 0.3156, 0.3415, 0.3914, 0.4008];
  const w4 = [0.0944, 0.0854, 0.0954, 0.1386, 0.1258, 0.2016, 0.2318, 0.2656, 0.2797];
...
export const teamMembers = [
  { name: "Isaac Bentata", role: "Co-Founder & COO", bg: "Ex Goldman Sachs", detail: "Closed the UMG worldwide deal. Secured $500K+ in grants. Deploys 10+ AI agents in production.", linkedin: "https://www.linkedin.com/in/isaacbc/" },
  { name: "Isaac Kamlish", role: "Co-Founder & CEO", bg: "Ex Instagram/Meta", detail: "Built the AI stack in-house. 90%+ of code written by AI agents. Built organic engine delivering 50M+ views.", linkedin: "https://www.linkedin.com/in/isaac-kamlish-a0901088/" },
  { name: "Carlos Bernal", role: "Senior Engineer / DevOps", bg: "Ex Munitienda (Head of Eng)", detail: "Leads technology decisions. Previous company raised $20M Series A.", linkedin: "https://www.linkedin.com/in/bernal-carlos/" },
  { name: "Carlos Saenz", role: "Software Engineer", bg: "Ex Munitienda", detail: "Previously engineering lead.", linkedin: "https://www.linkedin.com/in/cesaenzv/" },
  { name: "Ilken Bahcecioglu", role: "Software Engineer", bg: "Ex Encore Musicians", detail: "Previously Engineering Lead.", linkedin: "https://www.linkedin.com/in/ilken/" },
  { name: "Norman Wilde", role: "React Native Engineer", bg: "", detail: "", linkedin: "https://www.linkedin.com/in/norman-wilde/" },
  { name: "Jacint Varga", role: "React Native Engineer", bg: "", detail: "Top contributor to Expo and React Native GitHub repositories.", linkedin: "" },
  { name: "Ray Cheung", role: "Head of Product Design", bg: "Ex AKQA", detail: "Developed product design for Apple, Meta, and Nike.", linkedin: "https://www.linkedin.com/in/nacoki/" },
  { name: "Dora Yilmaz", role: "Support", bg: "", detail: "", linkedin: "https://www.linkedin.com/in/dora-yilmaz-5248851b9/" },
];
